...
public class PrivateKeyAuthenticator : IAuthenticator
{
    ...
    public PrivateKeyAuthenticator(string encryptedPrivateKey, string secret)
    {
        ...
        //Cache the parsed key on construction
        this._privateKey = LoadPrivateKey(this.EncryptedPrivateKey, this._secret);
    }
    ...
    {
        get => this._encryptedPrivateKey;
        set => this._encryptedPrivateKey = value;
    }
    ...
    // ============================== Helper ============================== //
    private Ed25519PrivateKeyParameters LoadPrivateKey(string pem, string password)
    {
        try
        {
